...
![Annotation of SpatialData in a Jupyter Widget using anybioimage.](figs/2.png)
...
![Gallery of spatialdata-plot examples with copy-able code.](figs/3.png)
...
![Benchmark results for multiscale, chunked point representations on 10M points across five query types (Q1–Q4), comparing spatial first, gene first, and baseline (unindexed) parquet layouts.](figs/4.png)
...
![SpatialData.js labels layer with interactive element picking and tooltip display.](figs/5.png)
...
![**a)** Field of view images of CosMx datasets before stitching. **b)** Proposed `fuse_spatialdata_images` function fusing image elements that are backed by dask arrays or in memory. **c)** napari view of the stitched image elements.](figs/10.png)
